...
def get_scatter_plot(entered_site, slide_range):
    low, high = slide_range
    mask = (spacex_df['Payload Mass (kg)'] > low) & (
        spacex_df['Payload Mass (kg)'] < high)
    if entered_site == 'All Sites':
        fig = px.scatter(data_frame=spacex_df[mask], x='Payload Mass (kg)',
                         y='class', color='Booster Version Category')
        return fig
    else:
        fig = px.scatter(data_frame=spacex_df[mask].loc[spacex_df['Launch Site'] == entered_site], x='Payload Mass (kg)',
                         y='class', color='Booster Version Category')
        return fig
